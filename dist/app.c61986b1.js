...
function newsFeed() {
  ...
  template = template.replace("{{__news_feed__}}", newsList.join("")); // Array.join -> 배열 안의 요소들을 하나의 문자열로 합침
...
function router() {
  ...
  if (routePath === "") {
    ...
    // indexOf('')  입력으로 주어지는 문자열을 찾아서 0 이상의 위치값을 리턴
...
},{}]},{},["../../.nvm/versions/node/v16.13.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.ts"], null)
